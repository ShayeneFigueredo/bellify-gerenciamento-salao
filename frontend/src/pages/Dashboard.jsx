  ...
  return (
    <aside className="sidebar">
      ...
      <nav className="sidebar-nav">
        ...
        <Link to="/admin" className={`sidebar-item ${active === 'agendamentos' ? 'sidebar-item--ativo' : ''}`}>
          <IconAgendamentos />
          Agendamentos
        </Link>
      </nav>
        ...
        <div className="layout-content">
          ...
          <div className="dashboard-cards">
            ...
            <div className="dash-card">
              ...
              <div className="dash-card-info">
                <span className="dash-card-numero">0</span>
                <span className="dash-card-label">Hoje</span>
              </div>
            </div>
          </div>
...
export { Sidebar, Topbar, IconServicos, IconProfissionais, IconAgendamentos, IconPlus, IconUserPlus, IconList, IconUser, IconCheck, IconHome }
